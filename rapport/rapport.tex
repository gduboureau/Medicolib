...
\begin{figure}[H]
    ...
    \caption{Page de réservation d'un docteur}
    \label{fig:DCU15}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Page Mon Compte du patient}
    \label{fig:DCU16}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Page RDV du patient (lorsqu'il n'y a pas de RDV)}
    \label{fig:DCU17}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Page Documents du patient (sans documents)}
    \label{fig:DCU20}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Page Documents du patient}
    \label{fig:DCU21}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Ajout d'une consultation sans prescription médicale}
    \label{fig:DCU26}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Ajout d'une consultation avec prescription médicale}
    \label{fig:DCU27}
\end{figure}
